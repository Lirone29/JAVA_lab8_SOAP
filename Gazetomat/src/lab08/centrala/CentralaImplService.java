 ...
 * 
 */
@WebServiceClient(name = "CentralaImplService", targetNamespace = "http://centrala.lab08/", wsdlLocation = "http://localhost:8090/WS/Cent?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8090/WS/Cent?wsdl");
